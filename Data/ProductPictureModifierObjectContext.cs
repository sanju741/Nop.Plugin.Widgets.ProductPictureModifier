...
namespace Nop.Plugin.Widgets.ProductPictureModifier.Data
{
    ...
    /// </summary>
    public class ProductPictureModifierObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public ProductPictureModifierObjectContext(DbContextOptions<ProductPictureModifierObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new LogoPositionMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(LogoPosition));
        }
