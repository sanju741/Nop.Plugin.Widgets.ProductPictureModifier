...
{
    /// <summary>
    /// Interface to combine logo and product's image to form a new image
    /// </summary>
    public interface ICustomLogoService
    {
        /// <summary>
        /// Creates new image merging the 1st picture of product with the uploaded logo  
        /// </summary>
        /// <param name="logoBinary">Binary value of uploaded logo</param>
        /// <param name="logoId">Id of the logo uploaded</param>
        /// <param name="productId">Product identifier</param>
        /// <param name="uploadType"></param>
        /// <param name="size">Size of logo in percent</param>
        /// <param name="opacity">Opacity of logo</param>
        /// <param name="targetSize">Size of the product image to be re-created</param>
        /// <param name="storeLocation">Store's Location</param>
        /// <param name="xCoordinate">Store's Location</param>
        /// <param name="yCoordinate">Store's Location</param>
        /// <param name="forceUpdate">Store's Location</param>
        /// <returns>Picture Id and image location of the new image created</returns>
        (int, string) MergeProductPictureWithLogo(
            byte[] logoBinary,
            int logoId,
            int productId,
            string uploadType,
